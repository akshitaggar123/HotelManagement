...
<html lang="en">
<head>
<title>IIT Jammu Guest House</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<ul class="social-icons3">
								<li><a href="https://www.iitjammu.ac.in/" class="fa fa-facebook icon-border facebook"> </a></li>
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">sachindrck25@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 6005053183</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">IIT Jammu  <span>Guest House</span><p class="logo_w3l_agile_caption">Welcome to Jammu!</p></a></h1>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 6005053183</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">sachindrck25@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong>Boys Hostel, IIT Jammu, Nagrota</p>
